...
// See http://www.cprogramming.com/c++11/rvalue-references-and-move-semantics-in-c++11.html
  void
  Construction::constructionTest_1 ()
  {
    T_START;
    class A
    {
    public:
      ...
      {
	     cout << "A(A&) invoked: copy constructor" << endl;
      };
      ...
      // 5. move constructor; need to use std::move on all members. Note all STL containers support std::move.
...
//	and all members and bases are moveable.
  ...
  void
  Construction::constructionTest_2 ()
  {
    T_START;
    class A
    {
