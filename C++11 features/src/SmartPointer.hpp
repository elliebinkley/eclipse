...
public:
	...
	inline A(A&& o) noexcept : m_ptr_string(std::move(o.m_ptr_string))   { std::cout << "A(A&&): move constructor invoked\n"; };
...
private:
	...
	inline friend bool operator==(const SmartPointer& lhs, const SmartPointer& rhs) { return false; };
	inline ~SmartPointer() { if ( m_smartPointer ) delete m_smartPointer; };
