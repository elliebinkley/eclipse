...
private:
	UniformInitializationSyntax() {};                                                       // make private the constructor
	UniformInitializationSyntax(const UniformInitializationSyntax& object) {};              // make private the copy constructor
	UniformInitializationSyntax& operator= (const UniformInitializationSyntax& object)      // make private the =  operator
	    {return *this; };
...
public:
	...
	friend bool operator==(const X& lhs, const X& rhs) { return( lhs.m_x == rhs.m_x);};
	friend bool operator!=(const X& lhs, const X& rhs) { return( lhs.m_x != rhs.m_x);};
private:
	std::string m_x;
};
