...
main ()
{
  ...
  B b (" B::string");
    ...
    }
    {
      ...
      std::cout << "enum= " << Mammal::Gender::female << "="
	  << getEnumValue (Mammal::Gender::female) << std::endl;
      std::cout << "enum= " << Mammal::Gender::male << "="
	  << getEnumValue (Mammal::Gender::male) << std::endl;

      // b. using the constexpr to initialize a static class
      std::cout << "m_array[" << Mammal::Gender::male << "]="
	  << Mammal::m_array[Mammal::Gender::male] << std::endl;
      ...
      std::cout << "m_genderMap[ " << Mammal::Gender::female << "]="
	  << Mammal::m_genderMap.at (Mammal::Gender::female) << std::endl;
    }
    {
      ...
      std::cout << "std::map: "
	  << std::is_literal_type<std::map<int, int>>::value << std::endl; // false
      std::cout << "std::array: "
	  << std::is_literal_type<std::array<const char*, 20>>::value
	  << std::endl; // true
