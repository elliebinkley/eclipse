...
int main()
{
   ...
   cout << " number of physical threads on this system = " << boost::thread::physical_concurrency()
         << endl;
   cout << " number of hardware threads on this system = " << boost::thread::hardware_concurrency()
         << endl;
